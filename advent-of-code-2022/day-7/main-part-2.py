...
file_system_size_used = directories["/"]
file_system_size_unused = file_system_size - file_system_size_used

required_free_space = 30_000_000
space_to_free = required_free_space - file_system_size_unused

dir_to_delete_size = 0

for directory in directories:
    if directories[directory] >= space_to_free:
        dir_to_delete_size = directories[directory]
